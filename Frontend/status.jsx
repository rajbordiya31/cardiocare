                    ...
                    <div className="mt-8 pt-8 border-t border-slate-100 animate-fade-in text-center">
                        ...
                        {appointment.confirmed_time && (
                            <div className="mt-4 p-4 bg-green-50 border border-green-100 rounded-2xl">
                                <div className="text-xs text-green-600 font-bold uppercase tracking-wider mb-1">Confirmed Visit Time</div>
                                <div className="text-2xl font-black text-green-700">{appointment.confirmed_time}</div>
                                <p className="text-xs text-green-600 mt-2">Please arrive 10 minutes before your time.</p>
                            </div>
                        )}
                        {!appointment.confirmed_time && appointment.preferred_slot && (
                            <div className="mt-2 text-sm text-slate-400">
                                Requested Session: {appointment.preferred_slot}
                            </div>
                        )}
                    </div>
                )}
